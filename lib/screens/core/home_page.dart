...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Determine the text for the avatar (first letter of full_name or email)
    String avatarText = 'U'; // Default
    if (userProfile != null) {
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton.icon(
                            ...
                            onPressed: () {
                              if (userProvider.userProfile?.role == UserRole.player) {
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => const PlayerDashboard()));
                              } else if (userProvider.userProfile?.role == UserRole.scout) {
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => const ScoutDashboard()));
                              }
                            },
                            style: ElevatedButton.styleFrom(
                              padding: const EdgeInsets.symmetric(vertical: 16),
                              backgroundColor: isLight ? const Color(0xFF303F9F) : theme.colorScheme.primary,
                        ...
                        Expanded(
                          child: OutlinedButton(
                            ...
                            style: OutlinedButton.styleFrom(
                              padding: const EdgeInsets.symmetric(vertical: 16),
                              foregroundColor: isLight ? const Color(0xFF303F9F) : Colors.white,
                              side: BorderSide(
                                color: isLight ? const Color(0xFF303F9F) : Colors.white,
                              ),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12),
                              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _FeatureCard(
                      ...
                      description: "Advanced cheat detection ensures fair and accurate assessments",
                    ...
                    _FeatureCard(
                      ...
                      description: "Instant performance feedback and benchmarking against peers",
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        backgroundColor: isLight ? Colors.black : theme.colorScheme.onSurface,
                        foregroundColor: isLight ? Colors.white : theme.colorScheme.surface,
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(12),
                        ),
                      ),
...
class _FeatureCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isLight ? Colors.white : theme.colorScheme.surface.withOpacity(0.5),
        borderRadius: BorderRadius.circular(16),
